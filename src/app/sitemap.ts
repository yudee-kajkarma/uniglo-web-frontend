...
const BLOG_SLUGS: string[] = [
    ...
    "antwerp-mothers-day-15-august-practical-guide",
    ...
    "last-minute-mothers-day-gift-antwerp",
    ...
    "mothers-day-natural-vs-lab-grown-diamond-gift",
    ...
    "why-antwerp-celebrates-mothers-day-15-august",
