...
export async function generateMetadata({
    ...
    const t = await getTranslations({
        locale,
        namespace: "blogWhatDoesARealDiamondLookLike",
    });

    return {
        title: t("metaTitle"),
        description: t("metaDescription"),
        alternates: buildLocaleAlternates("blogs/what-does-a-real-diamond-look-like", locale),
    };
}

const BlogPage = () => {
    const t = useTranslations("blogWhatDoesARealDiamondLookLike");
