...
export async function generateMetadata({
    ...
    const t = await getTranslations({
        locale,
        namespace: "blogLabGrownDiamondResaleValue2026",
    });

    return {
        title: t("metaTitle"),
        description: t("metaDescription"),
        alternates: buildLocaleAlternates("blogs/lab-grown-diamond-resale-value-2026", locale),
    };
}

const BlogPage = () => {
    const t = useTranslations("blogLabGrownDiamondResaleValue2026");
