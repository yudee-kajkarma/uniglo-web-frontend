...
export async function generateMetadata({
    ...
    const t = await getTranslations({
        locale,
        namespace: "blogJewelleryThatSpeaksLoveValentinesDay",
    });

    return {
        title: t("metaTitle"),
        description: t("metaDescription"),
        alternates: buildLocaleAlternates("blogs/jewellery-that-speaks-love-valentines-day", locale),
    };
}

const BlogPage = () => {
    const t = useTranslations("blogJewelleryThatSpeaksLoveValentinesDay");
