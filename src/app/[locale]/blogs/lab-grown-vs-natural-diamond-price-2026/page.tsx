...
export async function generateMetadata({
    ...
    const t = await getTranslations({
        locale,
        namespace: "blogLabGrownVsNaturalDiamondPrice2026",
    });

    return {
        title: t("metaTitle"),
        description: t("metaDescription"),
        alternates: buildLocaleAlternates("blogs/lab-grown-vs-natural-diamond-price-2026", locale),
    };
}

const BlogPage = () => {
    const t = useTranslations("blogLabGrownVsNaturalDiamondPrice2026");
