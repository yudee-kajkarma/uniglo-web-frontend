...
export async function generateMetadata({
    ...
    const t = await getTranslations({
        locale,
        namespace: "blogHowToInsureDiamondJewelry",
    });

    return {
        title: t("metaTitle"),
        description: t("metaDescription"),
        alternates: buildLocaleAlternates("blogs/how-to-insure-diamond-jewelry", locale),
    };
}

const BlogPage = () => {
    const t = useTranslations("blogHowToInsureDiamondJewelry");
