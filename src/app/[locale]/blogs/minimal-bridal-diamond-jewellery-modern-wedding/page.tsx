...
export async function generateMetadata({
    ...
    const t = await getTranslations({
        locale,
        namespace: "minimalBridalBlog",
    });

    return {
        title: t("metaTitle"),
        description: t("metaDescription"),
        alternates: buildLocaleAlternates("blogs/minimal-bridal-diamond-jewellery-modern-wedding", locale),
    };
}

const BlogPage = () => {
    const t = useTranslations("minimalBridalBlog");
