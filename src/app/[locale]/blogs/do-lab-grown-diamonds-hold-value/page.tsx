...
export async function generateMetadata({
    ...
    const t = await getTranslations({
        locale,
        namespace: "blogDoLabGrownDiamondsHoldValue",
    });

    return {
        title: t("metaTitle"),
        description: t("metaDescription"),
        alternates: buildLocaleAlternates("blogs/do-lab-grown-diamonds-hold-value", locale),
    };
}

const BlogPage = () => {
    const t = useTranslations("blogDoLabGrownDiamondsHoldValue");
