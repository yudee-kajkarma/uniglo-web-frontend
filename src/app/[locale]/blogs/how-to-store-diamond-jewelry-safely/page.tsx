...
export async function generateMetadata({
    ...
    const t = await getTranslations({
        locale,
        namespace: "blogHowToStoreDiamondJewelrySafely",
    });

    return {
        title: t("metaTitle"),
        description: t("metaDescription"),
        alternates: buildLocaleAlternates("blogs/how-to-store-diamond-jewelry-safely", locale),
    };
}

const BlogPage = () => {
    const t = useTranslations("blogHowToStoreDiamondJewelrySafely");
