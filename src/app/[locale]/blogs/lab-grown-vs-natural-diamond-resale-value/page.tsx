...
export async function generateMetadata({
    ...
    const t = await getTranslations({
        locale,
        namespace: "blogLabGrownVsNaturalDiamondResaleValue",
    });

    return {
        title: t("metaTitle"),
        description: t("metaDescription"),
        alternates: buildLocaleAlternates("blogs/lab-grown-vs-natural-diamond-resale-value", locale),
    };
}

const BlogPage = () => {
    const t = useTranslations("blogLabGrownVsNaturalDiamondResaleValue");
