...
export async function generateMetadata({
    ...
    const t = await getTranslations({
        locale,
        namespace: "blogGiaCertifiedLabGrownDiamondsGuide",
    });

    return {
        title: t("metaTitle"),
        description: t("metaDescription"),
        alternates: buildLocaleAlternates("blogs/gia-certified-lab-grown-diamonds-guide", locale),
    };
}

const BlogPage = () => {
    const t = useTranslations("blogGiaCertifiedLabGrownDiamondsGuide");
