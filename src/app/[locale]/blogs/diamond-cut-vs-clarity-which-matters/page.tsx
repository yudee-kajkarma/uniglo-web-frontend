...
export async function generateMetadata({
    ...
    const t = await getTranslations({
        locale,
        namespace: "blogDiamondCutVsClarityWhichMatters",
    });

    return {
        title: t("metaTitle"),
        description: t("metaDescription"),
        alternates: buildLocaleAlternates("blogs/diamond-cut-vs-clarity-which-matters", locale),
    };
}

const BlogPage = () => {
    const t = useTranslations("blogDiamondCutVsClarityWhichMatters");
