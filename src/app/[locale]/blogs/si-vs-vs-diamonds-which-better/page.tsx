...
export async function generateMetadata({
    ...
    const t = await getTranslations({
        locale,
        namespace: "blogSiVsVsDiamondsWhichBetter",
    });

    return {
        title: t("metaTitle"),
        description: t("metaDescription"),
        alternates: buildLocaleAlternates("blogs/si-vs-vs-diamonds-which-better", locale),
    };
}

const BlogPage = () => {
    const t = useTranslations("blogSiVsVsDiamondsWhichBetter");
