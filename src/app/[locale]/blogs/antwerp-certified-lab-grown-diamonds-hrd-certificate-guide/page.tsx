...
export async function generateMetadata({
    ...
    const t = await getTranslations({
        locale,
        namespace: "blogAntwerpCertifiedLabGrownDiamondsHrdCertificateGuide",
    });

    return {
        title: t("metaTitle"),
        description: t("metaDescription"),
        alternates: buildLocaleAlternates("blogs/antwerp-certified-lab-grown-diamonds-hrd-certificate-guide", locale),
    };
}

const BlogPage = () => {
    const t = useTranslations("blogAntwerpCertifiedLabGrownDiamondsHrdCertificateGuide");
