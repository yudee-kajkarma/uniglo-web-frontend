...
export async function generateMetadata({
    ...
    const t = await getTranslations({
        locale,
        namespace: "blogBestDiamondSizeForEngagementRing",
    });

    return {
        title: t("metaTitle"),
        description: t("metaDescription"),
        alternates: buildLocaleAlternates("blogs/best-diamond-size-for-engagement-ring", locale),
    };
}

const BlogPage = () => {
    const t = useTranslations("blogBestDiamondSizeForEngagementRing");
