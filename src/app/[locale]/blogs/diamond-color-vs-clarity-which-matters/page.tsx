...
export async function generateMetadata({
    ...
    const t = await getTranslations({
        locale,
        namespace: "blogDiamondColorVsClarityWhichMatters",
    });

    return {
        title: t("metaTitle"),
        description: t("metaDescription"),
        alternates: buildLocaleAlternates("blogs/diamond-color-vs-clarity-which-matters", locale),
    };
}

const BlogPage = () => {
    const t = useTranslations("blogDiamondColorVsClarityWhichMatters");
