...
export async function generateMetadata({
    ...
    const t = await getTranslations({
        locale,
        namespace: "blogLabGrownDiamondEngagementRings",
    });

    return {
        title: t("metaTitle"),
        description: t("metaDescription"),
        alternates: buildLocaleAlternates("blogs/lab-grown-diamond-engagement-rings", locale),
    };
}

const BlogPage = () => {
    const t = useTranslations("blogLabGrownDiamondEngagementRings");
