...
export async function generateMetadata({
    ...
    const t = await getTranslations({
        locale,
        namespace: "blogHowToTellIfADiamondIsRealAtHome",
    });

    return {
        title: t("metaTitle"),
        description: t("metaDescription"),
        alternates: buildLocaleAlternates("blogs/how-to-tell-if-a-diamond-is-real-at-home", locale),
    };
}

const BlogPage = () => {
    const t = useTranslations("blogHowToTellIfADiamondIsRealAtHome");
