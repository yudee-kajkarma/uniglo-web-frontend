...
export async function generateMetadata({
    ...
    const t = await getTranslations({
        locale,
        namespace: "blogOvalDiamondRingsWhyPopularWhoTheySuit",
    });
    ...
    return {
        ...
        alternates: {
            canonical: "https://www.uniglodiamonds.com/blogs/oval-diamond-obsession",
        },
    };
}

const BlogPage = () => {
    const t = useTranslations("blogOvalDiamondRingsWhyPopularWhoTheySuit");
