...
export async function generateMetadata({
    ...
    const t = await getTranslations({
        locale,
        namespace: "blogBestDiamondSettingsForEngagementRings",
    });

    return {
        title: t("metaTitle"),
        description: t("metaDescription"),
        alternates: buildLocaleAlternates("blogs/best-diamond-settings-for-engagement-rings", locale),
    };
}

const BlogPage = () => {
    const t = useTranslations("blogBestDiamondSettingsForEngagementRings");
