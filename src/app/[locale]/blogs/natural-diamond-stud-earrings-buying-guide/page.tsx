...
export async function generateMetadata({
    ...
    const t = await getTranslations({
        locale,
        namespace: "blogNaturalDiamondStudEarringsBuyingGuide",
    });

    return {
        title: t("metaTitle"),
        description: t("metaDescription"),
        alternates: buildLocaleAlternates("blogs/natural-diamond-stud-earrings-buying-guide", locale),
    };
}

const BlogPage = () => {
    const t = useTranslations("blogNaturalDiamondStudEarringsBuyingGuide");
