...
export async function generateMetadata({
    ...
    const t = await getTranslations({
        locale,
        namespace: "blogDiamondJewelryPiecesThatLookExpensive",
    });
    ...
    return {
        ...
        alternates: {
            canonical: "https://www.uniglodiamonds.com/blogs/looks-expensive-diamond-edit",
        },
    };
}

const BlogPage = () => {
    const t = useTranslations("blogDiamondJewelryPiecesThatLookExpensive");
