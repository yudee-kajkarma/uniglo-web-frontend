...
export async function generateMetadata({
    ...
    const t = await getTranslations({
        locale,
        namespace: "blogLabGrownDiamondsInBelgium",
    });

    return {
        title: t("metaTitle"),
        description: t("metaDescription"),
        alternates: buildLocaleAlternates("blogs/lab-grown-diamonds-in-belgium", locale),
    };
}

const BlogPage = () => {
    const t = useTranslations("blogLabGrownDiamondsInBelgium");
