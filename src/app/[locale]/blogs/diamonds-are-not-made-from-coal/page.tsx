...
export async function generateMetadata({
    ...
    const t = await getTranslations({
        locale,
        namespace: "blogDiamondsAreNotMadeFromCoal",
    });

    return {
        title: t("metaTitle"),
        description: t("metaDescription"),
        alternates: buildLocaleAlternates("blogs/diamonds-are-not-made-from-coal", locale),
    };
}

const BlogPage = () => {
    const t = useTranslations("blogDiamondsAreNotMadeFromCoal");
