...
export async function generateMetadata({
    ...
    const t = await getTranslations({
        locale,
        namespace: "blog4CaratLabGrownDiamondPrice2026",
    });

    return {
        title: t("metaTitle"),
        description: t("metaDescription"),
        alternates: buildLocaleAlternates("blogs/4-carat-lab-grown-diamond-price-2026", locale),
    };
}

const BlogPage = () => {
    const t = useTranslations("blog4CaratLabGrownDiamondPrice2026");
