...
export async function generateMetadata({
    ...
    const t = await getTranslations({
        locale,
        namespace: "blog3CaratNaturalDiamondPrice2026",
    });

    return {
        title: t("metaTitle"),
        description: t("metaDescription"),
        alternates: buildLocaleAlternates("blogs/3-carat-natural-diamond-price-2026", locale),
    };
}

const BlogPage = () => {
    const t = useTranslations("blog3CaratNaturalDiamondPrice2026");
