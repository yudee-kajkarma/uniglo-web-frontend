...
export async function generateMetadata({
    ...
    const t = await getTranslations({
        locale,
        namespace: "blogHowToSpotFakeDiamond",
    });

    return {
        title: t("metaTitle"),
        description: t("metaDescription"),
        alternates: buildLocaleAlternates("blogs/how-to-spot-fake-diamond", locale),
    };
}

const BlogPage = () => {
    const t = useTranslations("blogHowToSpotFakeDiamond");
