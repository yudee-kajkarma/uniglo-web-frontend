...
export async function generateMetadata({
    ...
    const t = await getTranslations({
        locale,
        namespace: "blogDiamondFluorescenceExplainedGoodOrBad",
    });

    return {
        title: t("metaTitle"),
        description: t("metaDescription"),
        alternates: buildLocaleAlternates("blogs/diamond-fluorescence-explained-good-or-bad", locale),
    };
}

const BlogPage = () => {
    const t = useTranslations("blogDiamondFluorescenceExplainedGoodOrBad");
