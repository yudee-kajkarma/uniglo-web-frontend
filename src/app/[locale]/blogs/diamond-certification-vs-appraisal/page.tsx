...
export async function generateMetadata({
    ...
    const t = await getTranslations({
        locale,
        namespace: "blogDiamondCertificationVsAppraisal",
    });

    return {
        title: t("metaTitle"),
        description: t("metaDescription"),
        alternates: buildLocaleAlternates("blogs/diamond-certification-vs-appraisal", locale),
    };
}

const BlogPage = () => {
    const t = useTranslations("blogDiamondCertificationVsAppraisal");
