...
export async function generateMetadata({
    ...
    const t = await getTranslations({
        locale,
        namespace: "blogDoLabGrownDiamondsPassDiamondTester",
    });

    return {
        title: t("metaTitle"),
        description: t("metaDescription"),
        alternates: buildLocaleAlternates("blogs/do-lab-grown-diamonds-pass-diamond-tester", locale),
    };
}

const BlogPage = () => {
    const t = useTranslations("blogDoLabGrownDiamondsPassDiamondTester");
