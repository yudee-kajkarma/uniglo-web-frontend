...
export async function generateMetadata({
    ...
    const t = await getTranslations({
        locale,
        namespace: "blogHowToChooseEngagementRingGuide",
    });

    return {
        title: t("metaTitle"),
        description: t("metaDescription"),
        alternates: buildLocaleAlternates("blogs/how-to-choose-engagement-ring-guide", locale),
    };
}

const BlogPage = () => {
    const t = useTranslations("blogHowToChooseEngagementRingGuide");
