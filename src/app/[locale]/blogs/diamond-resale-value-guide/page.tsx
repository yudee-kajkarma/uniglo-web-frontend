...
export async function generateMetadata({
    ...
    const t = await getTranslations({
        locale,
        namespace: "blogDiamondResaleValueGuide",
    });

    return {
        title: t("metaTitle"),
        description: t("metaDescription"),
        alternates: buildLocaleAlternates("blogs/diamond-resale-value-guide", locale),
    };
}

const BlogPage = () => {
    const t = useTranslations("blogDiamondResaleValueGuide");
