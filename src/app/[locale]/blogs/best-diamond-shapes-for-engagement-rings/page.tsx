...
export async function generateMetadata({
    ...
    const t = await getTranslations({
        locale,
        namespace: "blogBestDiamondShapesForEngagementRings",
    });

    return {
        title: t("metaTitle"),
        description: t("metaDescription"),
        alternates: buildLocaleAlternates("blogs/best-diamond-shapes-for-engagement-rings", locale),
    };
}

const BlogPage = () => {
    const t = useTranslations("blogBestDiamondShapesForEngagementRings");
