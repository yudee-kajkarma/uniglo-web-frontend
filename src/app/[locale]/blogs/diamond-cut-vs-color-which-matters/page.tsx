...
export async function generateMetadata({
    ...
    const t = await getTranslations({
        locale,
        namespace: "blogDiamondCutVsColorWhichMatters",
    });

    return {
        title: t("metaTitle"),
        description: t("metaDescription"),
        alternates: buildLocaleAlternates("blogs/diamond-cut-vs-color-which-matters", locale),
    };
}

const BlogPage = () => {
    const t = useTranslations("blogDiamondCutVsColorWhichMatters");
