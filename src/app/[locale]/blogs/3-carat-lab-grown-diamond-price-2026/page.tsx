...
export async function generateMetadata({
    ...
    const t = await getTranslations({
        locale,
        namespace: "blog3CaratLabGrownDiamondPrice2026",
    });

    return {
        title: t("metaTitle"),
        description: t("metaDescription"),
        alternates: buildLocaleAlternates("blogs/3-carat-lab-grown-diamond-price-2026", locale),
    };
}

const BlogPage = () => {
    const t = useTranslations("blog3CaratLabGrownDiamondPrice2026");
