...
export async function generateMetadata({
    ...
    const t = await getTranslations({
        locale,
        namespace: "blogWhyAreLabGrownDiamondsSoExpensive",
    });

    return {
        title: t("metaTitle"),
        description: t("metaDescription"),
        alternates: buildLocaleAlternates("blogs/why-are-lab-grown-diamonds-so-expensive", locale),
    };
}

const BlogPage = () => {
    const t = useTranslations("blogWhyAreLabGrownDiamondsSoExpensive");
