...
const Page = () => {
    ...
    const validateForm = () => {
        ...
        if (formData.password.length < 6) {
            toast.error(t("passwordMustBeAtLeast6"));
            return false;
        }
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            if (pendingCheck.hasPendingRegistration) {
                ...
                toast.success(resendResponse.message || t("otpResentSuccess"));
            ...
            <div className="relative z-10 container mx-auto px-4 flex flex-col lg:flex-row items-center justify-center gap-10 lg:gap-32 w-full h-full py-10">
                ...
                <div className="w-full max-w-[600px] bg-black/60 backdrop-blur-sm border border-white/10 rounded-3xl p-8 md:p-10 shadow-2xl">
                    ...
                    <form className="space-y-4"
                        ...
                        onInvalidCapture={(e) => (e.target as HTMLInputElement | HTMLSelectElement).setCustomValidity(t("pleaseFillOutThisField"))}
                        onInput={(e) => (e.target as HTMLInputElement | HTMLSelectElement).setCustomValidity("")}>
