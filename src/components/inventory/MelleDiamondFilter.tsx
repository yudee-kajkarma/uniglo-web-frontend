...
const MELLE_SHAPE_META: Record<string, { label: string; icon?: string }> = {
    ...
    BAGUETTE: { label: "Baguette" },
    CADILLAC: { label: "Cadillac" },
    CARRE: { label: "Carre" },
    "HALF MOON": { label: "Half Moon" },
    HEXAGON: { label: "Hexagon" },
    KITE: { label: "Kite" },
    "LILY CUT": { label: "Lily Cut" },
    "ROSE CUT": { label: "Rose Cut" },
    SHIELD: { label: "Shield" },
    "TAP BUG": { label: "Tap Bug" },
    TRAPEZE: { label: "Trapeze" },
